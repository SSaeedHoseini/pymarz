...
class UserTemplateResponse(BaseModel):
    ...
    id: StrictInt = Field(...)
    __properties = ["name", "data_limit", "expire_duration", "username_prefix", "username_suffix", "inbounds", "id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserTemplateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserTemplateResponse:
        """Create an instance of UserTemplateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserTemplateResponse.parse_obj(obj)

        _obj = UserTemplateResponse.parse_obj({
            "name": obj.get("name"),
