...
class SubscriptionUserResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionUserResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionUserResponse:
        """Create an instance of SubscriptionUserResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionUserResponse.parse_obj(obj)

        _obj = SubscriptionUserResponse.parse_obj({
