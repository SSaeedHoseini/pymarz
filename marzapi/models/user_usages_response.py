...
class UserUsagesResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserUsagesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserUsagesResponse:
        """Create an instance of UserUsagesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserUsagesResponse.parse_obj(obj)

        _obj = UserUsagesResponse.parse_obj({
