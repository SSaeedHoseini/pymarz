...
class UserUsageResponse(BaseModel):
    ...
    __properties = ["node_id", "node_name", "used_traffic"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserUsageResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserUsageResponse:
        """Create an instance of UserUsageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserUsageResponse.parse_obj(obj)

        _obj = UserUsageResponse.parse_obj({
