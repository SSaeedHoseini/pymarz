...
class UserTemplateModify(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserTemplateModify:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserTemplateModify:
        """Create an instance of UserTemplateModify from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserTemplateModify.parse_obj(obj)

        _obj = UserTemplateModify.parse_obj({
            "name": obj.get("name"),
